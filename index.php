...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="menu d-flex justify-content-center mt-4">
      <div class="row">
        <div class="col-6 d-flex justify-content-end">
          <button class="btn btn-dark w-75 rounded-pill">
        ...
        <div class="col-6 d-flex mt-4 justify-content-end">
          <button class="btn btn-dark w-75 rounded-pill">
        ...
        <div class="col-6 d-flex mt-4 justify-content-start">
          <button class="btn btn-dark w-75 rounded-pill">
